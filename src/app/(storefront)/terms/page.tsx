  ...
  return (
    <LegalPageLayout eyebrow="Legal" title="Terms of Service" updated="August 3, 2026">
      ...
      <LegalSection title="3. Payment">
        <p>
          Checkout — including shipping and payment — is handled by Razorpay, our primary payments partner, with
          Fastrr Checkout (by Shiprocket) offered as an alternative payment option. We accept payment online
          (card, UPI, netbanking and wallets) or Cash on Delivery, where available for your location. For online
          payments, your order is placed once payment is confirmed; for Cash on Delivery, payment is collected by
          our courier partner at the time of delivery.
        </p>
      </LegalSection>
