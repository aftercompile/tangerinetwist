...
// as /checkout?oid=<fastrr_order_id>&ost=<status>. The overlay itself is triggered from
// wherever "Checkout" is clicked (see fastrr-checkout-actions.ts + the cart page), not
// from a form on this page — there's no form here anymore.
